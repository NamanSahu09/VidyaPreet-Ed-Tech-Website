...
Got it. Here's the modified JavaScript code to persist the user name in the navigation bar until the user manually logs out:
...
With this modification, the user's name will persist in the navigation bar until the session ends or the user manually logs out by double-clicking their name.